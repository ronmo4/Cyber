...
const fetchFAQs = async () => {
    ...
    return [
        ...
        { question: 'האם בטרם אמסור גרסא לשוטר ניתן להתייעץ עם עורך דין?', answer: 'כן, לרוב מורשעים נאשמי תעבורה על פי ההודעה שהם מסרו לבעל הסמכות. לעיתים נאשמים אינם מודעים לחשיבות הדיוק בדברים הנאמרים על ידם. ייעוץ טרם מסירת הודאה יכול להפוך את הקערה על פיה.' },
        { question: 'האם ניתן לערער על החלטת המכון הרפואי לבטיחות בדרכים?', answer: 'ניתן לערער על החלטת המכון הרפואי לבטיחות בדרכים בפני ועדת הערר המונה הרכב של שלושה רופאים. חשוב מאוד להתייעץ ולקבל ייצוג משפטי הולם בטרם תועלה לועדה.' },
        { question: 'משרד הרישוי פסל את רישיוני האם עלי לעבור את מבחן התאוריה?', answer: 'בהחלטת בחלק מהמקרים טועה משרד הרישוי בחישוב הנקודות ובמקרים אחרים ניתן לפעול באמצעות בית המשפט לביטולן של הנקודות אך חשוב לפנות לייעוץ משפטי מייד עם קבלת ההודעה ממשרד הרישוי.' },
        { question: 'מה לעשות אם ברצוני לערער על עבירה בעת קבלת דוח?', answer: 'אם לא עברת את העבירה, הכחש בהזדמנות הראשונה את ביצוע העבירה. הדבר יעזור לך בהמשך שתרצה לערער.' },
        { question: 'מה לעשות כשהשוטר ביקש ממני לחתום על הדברים?', answer: 'אינך מחוייב לעשות זאת. בקש מן השוטר לקרוא את מה שכתב בדברי הנהג ואם רשום דברים שלא אמרת המהווים התוודות בעבירה עליך לבקש ממנו לכתוב במדוייק את דבריך והנך אף רשאי לבקש לכתוב את תגובתך בכתב ידך.' },
        { question: 'האם קצין יכול לפסול אותי שלא בנוכחותי בהזמנה לשימוע?', answer: 'לא. אם נעשה זאת ניתן לבטל את הפסילה המנהלית שניתנה על ידי הקצין מכיוון שלא בוצע שימוע כדין.' },
        { question: 'מה הכוונה בשיטת הניקוד לנהגים המורשעים בעבירות תעבורה?', answer: 'שיטת הניקוד היא מערכת שנועדה לזהות ולטפל בנהגים המבצעים עבירות תעבורה חוזרות ותכופות, ולא רק בעבירה חד פעמית. היא מחלקת עבירות לחמש דרגות שונות, כאשר לכל דרגה מוקצבות נקודות שונות לפי חומרת העבירה.' },
        { question: 'כיצד מחולקות דרגות הניקוד בשיטת הניקוד?', answer: 'הניקוד בשיטת הניקוד מחולק לחמש דרגות של ניקוד עבירות, אשר כוללות 2, 4, 6, 8, ו-10 נקודות בהתאם לחומרת העבירה.' },
        { question: 'מה קורה כאשר נהג צבר 12 נקודות תקפות או יותר?', answer: 'כאשר נהג צובר 12 נקודות תקפות או יותר, מוטלות עליו סנקציות משתנות בהתאם לכמות הנקודות שצבר. הסנקציות יכולות לכלול פסילת רישיון נהיגה ו/או השתתפות בקורסים לשיפור התנהגות הנהיגה.' },
        { question: 'מהי תקופת הצבירה במערכת הניקוד וכיצד היא משפיעה על הנהג?', answer: 'תקופת הצבירה היא התקופה בה נצברות הנקודות לחובת הנהג. בעבור צבירת נקודות בכמות מסוימת, יוטלו על הנהג אמצעים לתיקון המצב. הנקודות ישארו תקפות לתקופה שתלויה בכמות הנקודות שצבר.' },
        { question: 'כיצד ניתן למחוק נקודות מרישום הנהג?', answer: 'נקודות ניתן למחוק מרישום הנהג אם לא בוצעו עבירות נוספות במשך זמן מסוים והנהג ביצע את אמצעי התיקון הנדרש ממנו. כללית, רישום הנקודות תקף לשנתיים, אך יכול להארך לארבע שנים במקרים מסוימים.' },
...
const styles = StyleSheet.create({
    ...
    searchBox: {
        ...
        borderRadius: 10 // Adjust the value to make it fully circular
    },
    faqItem: {
        padding: 20,
